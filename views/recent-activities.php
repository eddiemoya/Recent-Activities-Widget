					...
					<li class="clearfix">
						...
						<div class="recent-activity_data">
							<ul>
								...
								<li class="recent-activity_title"><a href="<?php echo (in_array($activity->type, $recent->comment_types)) ? get_permalink($activity->post->ID) : get_permalink($activity->ID) ;?>"><?php echo (in_array($activity->type, $recent->comment_types)) ? truncated_text(sanitize_text($activity->post->post_title)) : truncated_text(sanitize_text($activity->title));?></a></li>
